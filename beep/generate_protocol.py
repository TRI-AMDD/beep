    ...
    for index, protocol_params in protocol_params_df.iterrows():
        ...
        if ".000" in template:
            ...
            if template_length == 23 and template == "EXP.000":
                ...
                elif protocol_params["project_name"] == "Drive":
        ...
        elif ".mps" in template and template == "formationV1.mps":
