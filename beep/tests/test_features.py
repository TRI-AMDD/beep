...
class TestFeaturizer(unittest.TestCase):
    ...
    def test_DiagnosticSummaryStats_class(self):
        with ScratchDir("."):
            ...
            x = [-1.6485909090031077, -2.9179799645329303, -0.7220563374564167, -1.040116826706696,
                 0.20159206434817353, 1.9407014942251573, 1.429360768041361, 0.06472613467088795,
                 -0.16707857858595423, -1.2239907685534328, 0.5974887023904467, 1.2348687349402938,
                 2.4086927278510815, 2.7553667067136374, 1.839132058679987, 1.132599396985598, 0.8140305407739941,
                 -0.3574758952033969, 0.0979457603551076, 3.63912212240519, 4.715711030913878, 1.1957736871376001,
                 0.44074638013353645, -0.6563046393304072, 0.5947778218488848, 1.231786192126058, 2.973734671087159,
                 3.886427566013026, -0.17902617156505585, -11.75220012664795, -0.403328001499176, 0.3780090882384182,
                 0.8755214997548952, 2.2622530460357666, 2.57846999168396, 0.7316035628318787, 0.9144985675811768,
                 -2.1977298259735107, 0.22656323376541287, 1.0993715101050061, 2.7620580196380615, 3.419135808944702]
            computed = featurizer.X.iloc[0].tolist()
            print(computed)
            for indx, value in enumerate(x):
                precision = 5
