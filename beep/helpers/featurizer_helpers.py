...
class DiagnosticCyclesFeaturesHelper(MSONable):
    ...
    def get_hppc_ocv_helper(cycle_hppc_0, step_num):
        ...
        for i in range(len(step_index_counters)):
            ...
            voltage1.append(
                df_i['voltage'].iloc[-10].mean())  # take the mean of the last 10 points of the voltage value
        return voltage1
    ...
    def get_energy_fraction(diag_num, processed_cycler_run, remaining, metric, cycle_type, file):
        ...
        """
        summary_diag = processed_cycler_run.diagnostic_summary[
